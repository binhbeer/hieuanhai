...
<section class="w-full">
    ...
    <x-settings.layout active="security" :heading="__('Update password')" :subheading="__('Ensure your account is using a long, random password to stay secure')">
                            ...
                            <div class="flex items-center justify-between p-4 {{ ! $loop->last ? 'border-b border-zinc-200 dark:border-zinc-700' : '' }}">
                                <div class="flex items-center gap-4">
                                    <div class="flex size-10 shrink-0 items-center justify-center rounded-xl bg-zinc-100 dark:bg-zinc-800">
                                        <x-iconsax-two-key class="size-5 text-zinc-500 dark:text-zinc-400" />
                                    </div>
                                    <div class="space-y-1">
                                ...
                                <flux:button
                                    variant="ghost"
                                    size="sm"
                                    :icon="svg('iconsax-two-trash', 'size-5')"
                        ...
                        @empty
                            <div class="p-8 text-center">
                                <div class="mx-auto mb-4 flex size-14 items-center justify-center rounded-2xl bg-zinc-100 dark:bg-zinc-800">
                                    <x-iconsax-two-key class="size-7 text-zinc-400 dark:text-zinc-500" />
                                </div>
