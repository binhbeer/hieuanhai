...
<section class="mx-auto w-full max-w-7xl space-y-6 p-4 sm:p-6 lg:p-8">
	...
	<flux:card class="space-y-3">
		...
		<pre class="overflow-x-auto rounded-xl bg-black/40 p-4 text-sm text-zinc-100"><code>curl -X POST https://api.{{ parse_url((string) config('app.url'), PHP_URL_HOST) }}/api/ai/images \
